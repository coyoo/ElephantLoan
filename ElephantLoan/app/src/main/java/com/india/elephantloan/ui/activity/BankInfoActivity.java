                            ...
                            if (yes == 200) {
                                ...
                                if ((!objectData.getString("infoAuthStatus").isEmpty()) && (!objectData.getString("infoAuthStatus").equals("null"))) {
                                    ...
                                    if (strInfoAuthStatus.equals("1")) {
                                        Intent intent = new Intent(BankInfoActivity.this, ElephantLoanActivity.class);
                                ...
                                BranchEventHelper.obtainBranchEvent(BankInfoActivity.this, "complete_verification", "verification");
                            } else {
